...
// add flavor to beginning of the array using .unshift
...
//two paramaters - array / string
//remove 'Rocky Road' using .splice(). .splice() takes two parameters - first is the index, second is how many items we want to remove.
//return the array
